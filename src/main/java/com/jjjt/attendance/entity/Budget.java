...
@ApiModel(value = "Budget", description = "收支明细表实体类")
public class Budget {
    ...
    @ApiModelProperty(value = "收支状态",name = "status")
    ...
    public Budget(int id, int conglomerate_id, int company_id, String company_name, int items_id, String items_name, int project_id, String project_name, int supplier_id, String supplier_name, String cost_types, String payment_amount, String payment_time, String explain, String picture, String state, String uptime, String status) {
        this.id = id;
